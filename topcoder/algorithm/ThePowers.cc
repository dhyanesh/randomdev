// BEGIN CUT HERE
// PROBLEM STATEMENT
// John chooses positive integer X that is at most A and Brus 
// chooses positive integer Y that is at most B.
...
// 
// 25 = 5^2, 27 = 3^3, 36 = 6^2, 49 = 7^2, 64 = 4^3, 81 = 
// 3^4, 125 = 5^3,
// 
// 216 = 6^3, 256 = 4^4, 343 = 7^3, 625 = 5^4, 1296 = 6^4 and 
// 2401 = 7^4.
// 
// 
// 1)
